...
export function activate(context: vscode.ExtensionContext) {
  ...
  const generateTemplateDisposable = vscode.commands.registerCommand(
    'ampersand-schema.generateTemplate',
    () => {
  ...
  context.subscriptions.push(generateTemplateDisposable, codeActionsDisposable, hoverDisposable);
}
...
function setupTelemetry(_context: vscode.ExtensionContext) {
